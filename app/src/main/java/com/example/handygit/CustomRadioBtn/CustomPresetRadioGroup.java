...
public class CustomPresetRadioGroup extends FlowLayout {
    ...
    public CustomPresetRadioGroup(Context context) {
        super(context);
        setupView();
    }

    public CustomPresetRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomPresetRadioGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CustomPresetRadioGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == CustomPresetRadioGroup.this && child instanceof RadioCheckable) {
                int id = child.getId();
